package a2l.tools.barcodeuploader.database;
...
import a2l.tools.barcodeuploader.utils.ItemParser;
...
//		database.execSQL(sql);
		...
		try {
			...
			for (int i = 0; i < jArray.length(); i++){
				...
				contentValues.put(ItemCst.FIELD_CATEGORY, obj.getString(ItemCst.CATEGORY));
